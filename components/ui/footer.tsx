        ...
        <div className="py-8 md:py-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-between mb-4 md:mb-6">
            <div className="shrink-0 mr-4">
              {/* Logo */}
              <Link className="inline-flex group mb-8 md:mb-0" href="/" aria-label="SRM Labs">
          ...
          <div className="text-center md:flex md:items-center md:justify-between">
            ...
            {/* Copyright */}
            <div className="text-sm text-gray-500">@srmlabs.tvvignesh.com | All rights reserved</div>
          </div>
        </div>
      </div>
    </footer>
