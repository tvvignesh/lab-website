  ...
  return (
    <div className="relative text-center px-4 py-6 group">
      <div
        ...
        aria-hidden="true"
      />
      <div className="font-nycd text-xl text-indigo-500 mb-1">Get notified about innovation @ SRM</div>
      <div className="text-2xl font-bold mb-5">Get a weekly email with the latest projects.</div>
